...
| 이름      | 역할              | 주요 기여 내용                             |
|-----------|-------------------|-------------------------------------------|
| 최동욱    | **프론트엔드 개발** | UI 설계, React 컴포넌트 개발, 반응형 디자인 구현 |
| 김지수    | **프론트엔드 개발** | REST API 설계 및 개발, 데이터베이스 모델링   |
| 윤승범    | **백엔드 개발**     | 페이지 디자인, 사용자 경험(UX) 개선         |
| 오규한    | **프로젝트 매니저** | 일정 관리, 팀 커뮤니케이션, GitHub 관리     |
