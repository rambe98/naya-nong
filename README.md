...
| 윤승범    | **백엔드 개발**     |  REST API 설계 및 개발, 백엔드 이슈 작성 및 관리,<br>기술문서 작성, 데이터베이스 모델링, 오픈 API 연결 및 가공 |
| 오규한    | **백엔드 개발(팀장)** | 일정 관리, 팀 커뮤니케이션, GitHub 관리, aws 배포,<br>REST API 설계 및 개발, 데이터베이스 모델링 |
